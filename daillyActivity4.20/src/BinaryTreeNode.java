 ...
 *
 * Used for Binary Search Tree (BST) in-class activity
 *
...
public class BinaryTreeNode<T> {
    ...
    public static void main(String[] args) {
        ...
        BinaryTreeNode<Integer> root3 = new BinaryTreeNode<Integer>(3);
        BinaryTreeNode<Integer> root4 = new BinaryTreeNode<Integer>(4);
        BinaryTreeNode<Integer> root5 = new BinaryTreeNode<Integer>(5);
        BinaryTreeNode<Integer> root6 = new BinaryTreeNode<Integer>(6);
        BinaryTreeNode<Integer> root8 = new BinaryTreeNode<Integer>(8);
        BinaryTreeNode<Integer> root9 = new BinaryTreeNode<Integer>(9);
        ...
        System.out.println(root6.toString());
